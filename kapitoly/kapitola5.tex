...
In the Fig. \ref{obr:Curing_curing} is presented curing of the material with respect to time, where we can see that the effect of curing slows with higher cure achieved. 
